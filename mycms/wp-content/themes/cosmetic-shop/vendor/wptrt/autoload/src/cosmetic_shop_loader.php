...
class Cosmetic_Shop_Loader {
	 ...
	 * @return void
	 */
	public function cosmetic_shop_add( $prefix, $paths ) {
	 ...
	 * @return void
	 */
	public function cosmetic_shop_remove( $prefix, $path = '' ) {
	 ...
	 * @return bool
	 */
	public function cosmetic_shop_has( $prefix, $path = '' ) {
		if ( $path ) {
	 ...
	 * @return void
	 */
	public function cosmetic_shop_register() {

		if ( $this->loaders ) {

			spl_autoload_register( function( $class ) {

				$this->cosmetic_shop_load( $class );
			}, true, true );
		}
	}
	/**
	 ...
	 * @return void
	 */
	protected function cosmetic_shop_load( $class ) {
